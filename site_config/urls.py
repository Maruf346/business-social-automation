...
admin.site.site_title = "Tatto Hysteria"
admin.site.site_header = "Tatto Hysteria"
admin.site.app_index = "Welcome to Tatto Hysteria Administrator"

# Main Base API Online Template
def Home(request):
    return JsonResponse({
        "application": "Tatto Hysteria API",
        "status": "online 🚀",
        "server_time": now(),
