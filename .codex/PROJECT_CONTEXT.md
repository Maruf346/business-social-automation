...
- First Telegram review/assignment/offer cards include a `Reference Image` section below Summary. When images exist, the section says they are attached below and the bot sends the stored incoming reference images as Telegram photo messages; when none exist, it shows `None`.
