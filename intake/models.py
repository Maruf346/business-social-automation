...
class IntakeRequest(models.Model):
    ...
    multi_entity_detected = models.BooleanField(default=False)
    complexity_notes = models.TextField(blank=True, default="")
    size_description = models.CharField(max_length=255, blank=True, default="")
    size_status = models.CharField(max_length=50, blank=True, default="")
    artist_preference_mode = models.CharField(max_length=50, blank=True, default="")
    pricing_requested = models.BooleanField(default=False)
    client_intent = models.CharField(max_length=100, blank=True, default="")
    conversation_status = models.CharField(max_length=100, blank=True, default="")
    intake_status = models.CharField(max_length=100, blank=True, default="")
    staff_review_required = models.BooleanField(default=False)
